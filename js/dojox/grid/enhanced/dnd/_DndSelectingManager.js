...
if (!dojo._hasResource["dojox.grid.enhanced.dnd._DndSelectingManager"]) {
	...
	dojo.declare("dojox.grid.enhanced.dnd._DndSelectingManager", dojox.grid.enhanced.plugins._Mixin, {typeSelectingMode:null, selectingDisabledTypes:null, drugSelectionStart:null, drugCurrentPoint:null, drugMode:null, keepState:false, extendSelect:false, headerNodes:null, selectedCells:null, selectedColumns:null, selectedClass:"dojoxGridRowSelected", autoScrollRate:1000, constructor:function (inGrid) {
		this.grid = inGrid;
