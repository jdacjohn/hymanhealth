...
if (!dojo._hasResource["dojox.grid.enhanced.plugins.NestedSorting"]) {
	...
	dojo.declare("dojox.grid.enhanced.plugins.NestedSorting", dojox.grid.enhanced.plugins._Mixin, {name:"nestedSorting", _minColWidth:63, _widthDelta:23, _minColWidthUpdated:false, _overResizeWidth:3, storeItemSelected:"storeItemSelectedAttr", _a11yText:{"dojoxGridDescending":"&#9662;", "dojoxGridAscending":"&#9652;", "dojoxGridAscendingTip":"&#1784;", "dojoxGridDescendingTip":"&#1783;", "dojoxGridUnsortedTip":"x"}, _unarySortCell:null, _sortTipMap:null, sortAttrs:null, exceptionalSelectedItems:null, constructor:function (inGrid) {
		...
		selectRegions.concat(unarySortWrappers).concat(nestedSortWrappers).forEach(function (region) {
			this.connect(region, "onmousemove", dojo.hitch(this.grid, this.grid._toggleHighlight, this));
	...
	dojo.declare("dojox.grid.enhanced.plugins._NestedSortingFocusManager", dojox.grid._FocusManager, {lastHeaderFocus:null, currentHeaderFocusEvt:null, cssMarkers:["dojoxGridHeaderCellSelectRegion", "dojoxGridNestedSortWrapper", "dojoxGridUnarySortWrapper"], _focusBorderBox:null, constructor:function () {
