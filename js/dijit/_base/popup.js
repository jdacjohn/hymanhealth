...
if (!dojo._hasResource["dijit._base.popup"]) {
	...
	dijit.popup = {_stack:[], _beginZIndex:1000, _idGen:1, moveOffScreen:function (widget) {
		var wrapper = widget.declaredClass ? widget._popupWrapper : (dojo.hasClass(widget.parentNode, "dijitPopup") && widget.parentNode), node = widget.domNode || widget;
		if (wrapper) {
			dojo.style(wrapper, {visibility:"hidden", top:"-9999px"});
		} else {
			wrapper = dojo.create("div", {"class":"dijitPopup", style:{visibility:"hidden", top:"-9999px"}, role:"presentation"}, dojo.body());
