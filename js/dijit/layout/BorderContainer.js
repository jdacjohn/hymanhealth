...
if (!dojo._hasResource["dijit.layout.BorderContainer"]) {
	...
	dojo.declare("dijit.layout.BorderContainer", dijit.layout._LayoutWidget, {design:"headline", gutters:true, liveSplitters:true, persist:false, baseClass:"dijitBorderContainer", _splitterClass:"dijit.layout._Splitter", constructor:function () {
		this._splitters = {};
		...
		this._splitterThickness[region] = this._splitterThickness[region] || dojo._getMarginSize(this._splitters[region])[(/top|bottom/.test(region) ? "h" : "w")];
	}, layout:function () {
		...
		this.inherited(arguments);
	}, _layoutChildren:function (changedRegion, changedRegionSize) {
		...
		if (changedRegion) {
			var child = this["_" + changedRegion + "Widget"], mb = {};
		...
		if (janky) {
			...
			var notifySides = !changedRegion || (/top|bottom/.test(changedRegion) && this.design != "sidebar"), notifyTopBottom = !changedRegion || (/left|right/.test(changedRegion) && this.design == "sidebar"), notifyList = {center:true, left:notifySides, right:notifySides, top:notifyTopBottom, bottom:notifyTopBottom};
	...
	dojo.declare("dijit.layout._Splitter", [dijit._Widget, dijit._Templated], {live:true, templateString:"<div class=\"dijitSplitter\" dojoAttachEvent=\"onkeypress:_onKeyPress,onmousedown:_startDrag,onmouseenter:_onMouse,onmouseleave:_onMouse\" tabIndex=\"0\" role=\"separator\"><div class=\"dijitSplitterThumb\"></div></div>", postMixInProperties:function () {
		...
		var available = dojo.contentBox(this.container.domNode)[dim] - (oppNode ? dojo._getMarginSize(oppNode)[dim] : 0) - 20 - thickness * 2;
